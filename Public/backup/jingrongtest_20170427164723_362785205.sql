/* This file is created by MySQLReback 2017-04-27 16:47:22 */
 /* 创建表结构 `cms_admin` */
 ...
 /* 插入数据 `cms_admin` */
 INSERT INTO `cms_admin` VALUES ('1','admin','21232f297a57a5a743894a0e4a801fc3','','1493282782','127.0.0.1','1'),('11','zhangsan','96e79218965eb72c92a549dd5a330112','','1493099377','127.0.0.1','1');/* MySQLReback Separation */
 /* 创建表结构 `cms_ads_plate` */
 ...
 /* 创建表结构 `cms_loginlog` */
 DROP TABLE IF EXISTS `cms_loginlog`;/* MySQLReback Separation */ CREATE TABLE `cms_loginlog` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `loginip` varchar(25) DEFAULT '',
  `loginaddress` varchar(55) DEFAULT '',
  `num` mediumint(1) DEFAULT '0',
  `status` smallint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;/* MySQLReback Separation */
 /* 插入数据 `cms_loginlog` */
 INSERT INTO `cms_loginlog` VALUES ('1','127.0.0.1','','0','1');/* MySQLReback Separation */
 /* 创建表结构 `cms_member` */
 DROP TABLE IF EXISTS `cms_member`;/* MySQLReback Separation */ CREATE TABLE `cms_member` (
  ...
  `lastlogintime` int(10) DEFAULT NULL,
  `lastloginip` varchar(20) DEFAULT '',
  `status` smallint(1) DEFAULT '1' COMMENT '是否锁定1：正常0：锁定',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=utf8;/* MySQLReback Separation */
 /* 插入数据 `cms_member` */
 INSERT INTO `cms_member` VALUES ('23','15210987765','20917c851c4a54f2a054390dac9085b7','','15210987765','0','','1','','','1493022375','1493099212','127.0.0.1','1'),('22','adminasds@qq.com','20917c851c4a54f2a054390dac9085b7','adminasds@qq.com','','0','','1','','','1493022002','','','1'),('20','admin@qq.com','20917c851c4a54f2a054390dac9085b7','admin@qq.com','','0','','1','','','','1493098953','127.0.0.1','0');/* MySQLReback Separation */
