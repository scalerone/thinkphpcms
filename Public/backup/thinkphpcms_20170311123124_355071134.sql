/* This file is created by MySQLReback 2017-03-11 12:31:24 */
 /* 创建表结构 `cms_admin` */
 ...
 /* 插入数据 `cms_admin` */
 INSERT INTO `cms_admin` VALUES ('1','admin','21232f297a57a5a743894a0e4a801fc3','','1489202984','127.0.0.1','1'),('3','test','098f6bcd4621d373cade4e832627b4f6','','1488954587','127.0.0.1','1'),('4','ads','2deb000b57bfac9d72c14d4ed967b572','','0','','1'),('5','test2','ad0234829205b9033196ba818f7a872b','','1488965209','127.0.0.1','1');/* MySQLReback Separation */
 /* 创建表结构 `cms_article` */
 DROP TABLE IF EXISTS `cms_article`;/* MySQLReback Separation */ CREATE TABLE `cms_article` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=68 DEFAULT CHARSET=utf8;/* MySQLReback Separation */
 /* 插入数据 `cms_article` */
 INSERT INTO `cms_article` VALUES ('64','sanyuketang111','课堂111','2宇铿发阿斯达斯的&lt;img src=&quot;./Uploads/2017-03-02/58b78fb3929cd.jpg&quot; alt=&quot;58b78fb3929cd.jpg&quot;&gt;','2','1488384000','admin11','三语课程111','./Uploads/2017-03-11/58c3702aef1ef.jpg','3','1','1','1','1','0'),('63','asdas','asd','dasdad','47','1488297600','','','./Uploads/2017-03-01/58b694f7d3e2f.jpg','4','1','0','1','0','0'),('66','test	','test','test','1','1489161600','asd','asd','','0','1','0','0','0','0'),('67','11','11','111','1','1489161600','11','11','','20','1','1','1','0','0');/* MySQLReback Separation */
 ...
 /* 插入数据 `cms_category` */
 INSERT INTO `cms_category` VALUES ('1','三语课堂','1','0','./Uploads/2017-02-27/58b3e98d5a838.jpg','1488185754','别名','1','1','描述'),('2','招聘信息1','0','0','./Uploads/2017-03-11/58c372443ec91.jpg','1488185971','','1','2',''),('46','测试','0','0','./Uploads/2017-03-08/58bfbc21c6c21.jpg','1488270397','栏目别名','1','3','测试栏目描述'),('47','测试22','0','46','./Uploads/2017-03-01/58b662e4e405a.jpg','1488270895','栏目别名1222','1','3','测试栏目描述122'),('48','asdasd','0','0','','1488442235','','1','1','asd');/* MySQLReback Separation */
 /* 创建表结构 `cms_links` */
