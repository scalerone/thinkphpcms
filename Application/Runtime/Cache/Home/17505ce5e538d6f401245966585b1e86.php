		...
		<div class="position">
			<div class="container clear">
				<div class="left float_l">
					<p>
						<span class="h2">
							<?php $cates= M("category")->where("status=1")->order("sort ASC")->select();$cates=cateSort2Child($cates,93);foreach($cates as $key=>$cate_val): extract($cate_val);$index=$key+1;if($type==1) $url=U("/list/".$id);if($type==2) $url=U("/page/".$id); endforeach;?>
						</span>
		...
		<div class="content">
			<div class="container">
				...
				<div class="con">
					...
					<a href="<?php echo ($article[files][0]['fileurl']); ?>"><?php echo ($article[files][0]['filename']); ?></a>
				</div>
				<div class="fenx mt50">
