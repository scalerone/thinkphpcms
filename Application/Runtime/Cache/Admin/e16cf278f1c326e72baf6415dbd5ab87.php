        ...
        <div class="result-wrap">
            <div class="result-content">
               <form class="layui-form " action="<?php echo U('Article/add');?>" method="post" enctype="multipart/form-data" id="addForm">
                  ...
                  <div class="layui-form-item files_dom">
                    <label class="layui-form-label">附件：</label>
                    <div class="layui-inline">
                        <input style="width: 300px;" type="text" lay-verify="required" autocomplete="off" class="layui-input" value="">
                    </div>
                    <div class="layui-inline">
                        <input type="text" lay-verify="required" autocomplete="off" class="layui-input" value="">
                    </div>
                    <div class="layui-inline" style="width:auto;">
                        <label class="layui-btn">
                          附件上传<input type="file" name="files" value="附件" style="width:1px;opacity: 0;height: 1;display: none;">
                        </label>
                    </div>
                    <div class="layui-inline nextadd">
                        <a class="addbtn layui-btn ">继续添加</a>
                    </div>
                  </div>

                   <div class="layui-form-item addfilebox">
                    <div class="layui-input-block">
                      <a type="submit" class="layui-btn submit" lay-submit="" >添加</a>
                    </div>
                  </div>
                </form>
            </div>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
      ...
      ,laydate = layui.laydate;
        ...
        $('.addbtn').on('click',function(){
          var $pare = $(this).parents('.files_dom');
          var $dom = $pare.clone();
          $dom.find('.nextadd').remove();
          $dom.append('<div class="layui-inline"><a class="delbtn layui-btn layui-btn-danger">删除</a></div>');
          $pare.after($dom);

          $('.delbtn').on('click',function(){
            $(this).parents('.files_dom').remove();
          });
        });
