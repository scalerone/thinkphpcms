            ...
            <form method="post">
                ...
                <div class="result-content">
                    ...
                    <?php if(is_array($categories)): $i = 0; $__LIST__ = $categories;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><input class="common-text common-text-center" size="3" type="text" value="<?php echo ($vo["sort"]); ?>" name="sort"></td>
                            ...
                            <td class="layui-form">
                                <input value="1" type="checkbox" name="status" lay-skin="switch" <?php echo ($vo["status"]==1?'checked':''); ?>>
                                </td>
                            <td>
                                <div class="layui-btn-group">
                                    <a title="添加子栏目" href="<?php echo U('Article/add');?>" class="layui-btn layui-btn-small">
