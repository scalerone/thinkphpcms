                    ...
                    <div class="layui-tab-content" style="min-height: 360px;">
                      ...
                      <div class="layui-tab-item">
                        <div class="layui-form-item">
                          ...
                          <div class="layui-input-block">
                             <input type="checkbox" lay-skin="primary" value="true" name="HTML_CACHE_ON" value="1" title="是" checked="checked">
                          </div>
                        </div>
                        <div class="layui-form-item">
                          <label class="layui-form-label">后缀</label>
                          <div class="layui-input-block">
                            <input type="text" name="HTML_FILE_SUFFIX" autocomplete="off" class="layui-input" value="<?php echo (C("HTML_FILE_SUFFIX")); ?>">
                          </div>
                        </div>
                      </div>
