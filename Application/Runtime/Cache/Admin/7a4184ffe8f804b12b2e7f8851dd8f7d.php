...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="iconfont">&#xe607;</i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">文章管理</span></div>
        </div>
            ...
            <form method="post" action="<?php echo U('Article/updateSort');?>" class="sortForm ">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Article/add');?>"><i class="iconfont">&#xe762;</i>新增文章</a>
                ...
                <div class="result-content">
                    <?php if(!empty($articles)): ?><table class="layui-table layui-form">
                            <thead>
                                <tr>
