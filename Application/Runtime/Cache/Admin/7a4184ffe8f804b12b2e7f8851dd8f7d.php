                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-input sort-input" name="ord[]" value="0" type="text" size="5">
                            </td>
                            <td>59</td>
                            <td title="发哥经典">发哥经典发哥经典发哥经典发哥经典…
                            </td>
                            <td>2</td>
                            <td>admin</td>
                            <td>2014-03-15 21:11:01</td>
                            <td>
                                <a class="link-update" href="<?php echo U('Article/edit');?>">修改</a>
